...
We provide unified shell script for four-phase incremental training on Games/Software respectively.
```bash
nohup python experiments/run_dual_layer_cl.py --data_path CoCo-data/Software_11111_0.1 --dataset Software_11111_0.1 --base_model ~/CoCo/models/Qwen/Qwen2___5-1___5B --device cuda:0 --num_phases 4 --replay_ratio 0.3 --start_phase 2 --output_dir ./experiments/software_replay0.3 > run_soft2.log 2>&1 &

### Main Experimental Results
#### 1. RQ-VAE Layer Metrics ($\text{MSE} \times10^{-2}$ / Encoder Similarity / Collision Rate)
...
#### 3. Ablation Results (Games, Phase3)
...
|Baseline|0.0112|0.0145|0.0102|0.0189|
