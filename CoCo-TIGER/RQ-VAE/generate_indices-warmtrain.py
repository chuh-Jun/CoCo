...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default=None, help='output directory for indices')
    parser.add_argument('--data_path_override', type=str, default=None, help='data path override')
...
output_dir = pargs.output_dir if pargs.output_dir else os.path.join(os.path.dirname(ckpt_path), 'indices')
...
data_path = pargs.data_path_override if pargs.data_path_override else ''
